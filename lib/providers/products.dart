...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    Uri url = Uri.parse(
        'https://shop-dedd8-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filteredString');
    try {
      ...
      url = Uri.parse(
          'https://shop-dedd8-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken');
  ...
  Future<void> addProduct(Product product) async {
    final Uri url = Uri.parse(
        'https://shop-dedd8-default-rtdb.firebaseio.com/products.json?auth=$authToken');
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final Uri url = Uri.parse(
          'https://shop-dedd8-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
